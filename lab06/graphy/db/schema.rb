...
ActiveRecord::Schema.define(:version => 20120408060446) do
  ...
  create_table "action_items", :force => true do |t|
    ...
    t.integer  "action_category_id", :limit => 10
    t.datetime "created_at",         :limit => 26, :null => false
    t.datetime "updated_at",         :limit => 26, :null => false
  end

  create_table "action_ratings", :force => true do |t|
    t.integer  "action_id",  :limit => 10
  ...
  create_table "metrics", :force => true do |t|
    t.string   "name"
    t.string   "description"
    t.integer  "min_rating",  :limit => 10
    t.integer  "max_rating",  :limit => 10
    t.datetime "created_at",  :limit => 26, :null => false
    t.datetime "updated_at",  :limit => 26, :null => false
  end

  create_table "ratings", :force => true do |t|
    t.integer  "user_action_item_id", :limit => 10
    t.integer  "metric_id",           :limit => 10
    t.integer  "week_number",         :limit => 10
    t.integer  "value",               :limit => 10
    t.string   "pros"
    t.string   "cons"
    t.datetime "created_at",          :limit => 26, :null => false
    t.datetime "updated_at",          :limit => 26, :null => false
  ...
  create_table "user_action_items", :force => true do |t|
    t.integer  "user_id",        :limit => 10
    t.integer  "action_item_id", :limit => 10
    t.datetime "created_at",     :limit => 26, :null => false
    t.datetime "updated_at",     :limit => 26, :null => false
  end
